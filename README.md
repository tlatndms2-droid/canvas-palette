...
- Saving a Canvas Item that is already in the selected Side Palette Workspace keeps exactly one Item and now reports that no duplicate was saved. A mixed selection reports both the newly saved count and the count already present.
