...
export class CardToMarkdownModal extends Modal {
  ...
  onOpen(): void {
    ...
    this.contentEl.createEl("p", { text: "Create one Markdown file, convert this Palette Card to a Markdown item, and convert every linked Canvas Card to a file node pointing to the same file." });
