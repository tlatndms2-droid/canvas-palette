...
test("Card conversion creates one Markdown file and converts Palette and linked Canvas Cards", () => {
...
test("Card conversion dialog explains and performs the linked conversion", () => {
  ...
  assert.match(modal, /convert this Palette Card to a Markdown item/);
  assert.match(modal, /convert every linked Canvas Card to a file node/);
});
