...
test("linked Canvas nodes render a non-interactive top-left link badge", () => {
  ...
  assert.match(styles, /\.cp-canvas-link-badge\{[^}]*left:calc\(7px \* var\(--cp-canvas-meta-scale,1\)\)[^}]*pointer-events:none/);
});
